...
export class EventForm extends Component {
    ...
    onDropdownClick(event){
        ...
        this.eventService.addEvent(shackName, shackType[0], sStartDate,sStartDate,snstartDate,snendDate,1,smaxSize[0],sportfolio[0],slocation[0],spoc,0,0).then(res =>  window.location = '#/eventDashboard')
